...
public class MqttController {
    ...
    private static Associar_robo r1 = new Associar_robo();
    private static Associar_robo r2 = new Associar_robo();
    ...
    public MQTTCli newMqttCli(Vertx vertx) {
        this.mqttCli = new MQTTCli(vertx);
        return mqttCli;
    }
