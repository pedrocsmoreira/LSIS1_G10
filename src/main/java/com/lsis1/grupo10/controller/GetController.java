...
public class GetController {
    ...
    public ArrayList<Competicao> getCompeticoesEquipa() throws SQLException {
        ...
        for (int i = 0; i < listaCompeticoes.size(); i++) {
            ...
            rset = ps.executeQuery();
            if (rset.next()) {
                listaCompeticoes.get(i).setEquipalogadoAssociado(true);
            } else {
                listaCompeticoes.get(i).setEquipalogadoAssociado(false);
            }
        }
        conn.close();
        return listaCompeticoes;
        ...
        try {
            ...
            for (int i = 0; i < comps.size(); i++) {
                ...
                if (rset.next()) {
                    ...
                    listaEquipas.get(comps.get(i).getIdequipaassociada()).addCompeticao(comps.get(i));
                }
            }
    ...
    public ArrayList<Juri> getOrganizadorJuris() throws SQLException {
        ...
        try {
            ...
            for (int i = 0; i < comps.size(); i++) {
                ...
                if (rset.next()) {
                    comps.get(i).setNome(rset.getString("nome"));
                    listaJuris.get(comps.get(i).getIdequipaassociada()).addCompeticao(comps.get(i));
                }
            }
